...
v0.new("<Color=Cyan>Welcome to Linh đep zai Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(119296015964992) ;
	...
	v197.Text = "Linh đep zai Roblox Hub";
	v197.TextSize = 17;
...
v8.Image = "rbxassetid://119296015964992";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Linh đep zai Roblox Hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=119296015964992&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
