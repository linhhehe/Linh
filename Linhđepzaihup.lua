...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Dev-BlueX/BlueX-Hub/refs/heads/main/FindFruits.lua"))()
 ...
 Tabs.Main1:AddButton({
    Title="Linhđepzaii Hub nè tg lon",
    Description="",
    Callback=function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/linhhehe/Linh/refs/heads/main/sourcescript.lua"))()
    end
  })
  
  Tabs.Main1:AddButton({
    Title="OMG Hub nè tg lon",
    Description="",
    Callback=function()
