        ...
        {"MainModule"},
        {
            ...
            {28, "ModuleScript", {"Icons"}},
            {
                ...
                {"Themes"},
                {
                    ...
                    {50, "ModuleScript", {"HNCRobloxXanhLa"}},
                    {51, "ModuleScript", {"HNCRobloxDo"}},
                    {52, "ModuleScript", {"HNCRobloxVang"}},
                    {53, "ModuleScript", {"HNCRobloxXanhDuong"}},
                    {54, "ModuleScript", {"HNCRobloxCauVong"}}
...
local aa = {
    ...
    return {
        Name = "HNCRobloxXanhLa",
        Accent = Color3.fromRGB(50, 200, 50),
        AcrylicMain = Color3.fromRGB(20, 40, 20),
        AcrylicBorder = Color3.fromRGB(40, 80, 40),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 40, 20), Color3.fromRGB(15, 30, 15)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(60, 100, 60),
        Tab = Color3.fromRGB(50, 100, 50),
        Element = Color3.fromRGB(40, 80, 40),
        ElementBorder = Color3.fromRGB(20, 40, 20),
        InElementBorder = Color3.fromRGB(60, 100, 60),
        ElementTransparency = 0.82,
        DropdownFrame = Color3.fromRGB(60, 100, 60),
        ...
        DialogHolderLine = Color3.fromRGB(20, 35, 20),
        DialogButton = Color3.fromRGB(40, 80, 40),
        DialogButtonBorder = Color3.fromRGB(60, 100, 60),
        DialogBorder = Color3.fromRGB(50, 80, 50),
        DialogInput = Color3.fromRGB(45, 75, 45),
        DialogInputLine = Color3.fromRGB(80, 120, 80),
...
[55] = function()
    ...
    return {
        ...
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 20, 20), Color3.fromRGB(30, 15, 15)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(100, 50, 50),
        Tab = Color3.fromRGB(120, 60, 60),
        Element = Color3.fromRGB(80, 40, 40),
        ElementBorder = Color3.fromRGB(40, 20, 20),
        InElementBorder = Color3.fromRGB(100, 50, 50),
        ElementTransparency = 0.82,
        DropdownFrame = Color3.fromRGB(120, 60, 60),
        DropdownHolder = Color3.fromRGB(50, 25, 25),
        DropdownBorder = Color3.fromRGB(40, 20, 20),
        Dialog = Color3.fromRGB(60, 30, 30),
        DialogHolder = Color3.fromRGB(50, 25, 25),
        DialogHolderLine = Color3.fromRGB(40, 20, 20),
        DialogButton = Color3.fromRGB(80, 40, 40),
        DialogButtonBorder = Color3.fromRGB(100, 50, 50),
        DialogBorder = Color3.fromRGB(90, 45, 45),
        DialogInput = Color3.fromRGB(70, 35, 35),
        DialogInputLine = Color3.fromRGB(120, 60, 60),
        Text = Color3.fromRGB(255, 255, 255),
...
[56] = function()
    ...
    return {
        ...
        AcrylicMain = Color3.fromRGB(50, 50, 20),
        AcrylicBorder = Color3.fromRGB(90, 90, 40),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 60, 20), Color3.fromRGB(40, 40, 15)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(100, 100, 40),
        Tab = Color3.fromRGB(120, 120, 50),
        Element = Color3.fromRGB(90, 90, 40),
        ElementBorder = Color3.fromRGB(50, 50, 20),
        InElementBorder = Color3.fromRGB(120, 120, 50),
        ElementTransparency = 0.82,
        DropdownFrame = Color3.fromRGB(120, 120, 50),
        DropdownHolder = Color3.fromRGB(60, 60, 25),
        DropdownBorder = Color3.fromRGB(50, 50, 20),
        Dialog = Color3.fromRGB(70, 70, 30),
        DialogHolder = Color3.fromRGB(50, 50, 20),
        DialogHolderLine = Color3.fromRGB(40, 40, 15),
        DialogButton = Color3.fromRGB(90, 90, 40),
        DialogButtonBorder = Color3.fromRGB(120, 120, 50),
        DialogBorder = Color3.fromRGB(100, 100, 45),
        DialogInput = Color3.fromRGB(80, 80, 35),
        DialogInputLine = Color3.fromRGB(130, 130, 60),
        Text = Color3.fromRGB(255, 255, 255),
        SubText = Color3.fromRGB(230, 230, 200)
    }
end,
[57] = function()
    local aa, ab, ac, ad, ae = b(57)
    return {
        Name = "HNCRobloxXanhDuong",
        Accent = Color3.fromRGB(80, 160, 255),
        AcrylicMain = Color3.fromRGB(20, 30, 50),
        AcrylicBorder = Color3.fromRGB(40, 60, 100),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 50, 80), Color3.fromRGB(15, 25, 40)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(60, 100, 150),
        Tab = Color3.fromRGB(80, 120, 180),
        Element = Color3.fromRGB(40, 60, 100),
        ElementBorder = Color3.fromRGB(20, 30, 50),
        InElementBorder = Color3.fromRGB(80, 120, 180),
        ElementTransparency = 0.82,
        DropdownFrame = Color3.fromRGB(80, 120, 180),
        DropdownHolder = Color3.fromRGB(30, 50, 80),
        DropdownBorder = Color3.fromRGB(20, 30, 50),
        Dialog = Color3.fromRGB(30, 50, 80),
        DialogHolder = Color3.fromRGB(25, 45, 75),
        DialogHolderLine = Color3.fromRGB(20, 40, 60),
        DialogButton = Color3.fromRGB(40, 60, 100),
        DialogButtonBorder = Color3.fromRGB(60, 100, 150),
        DialogBorder = Color3.fromRGB(50, 80, 120),
        DialogInput = Color3.fromRGB(45, 75, 110),
...
[58] = function()
    ...
    return {
        ...
        DialogInput = Color3.fromRGB(70, 70, 70),
        DialogInputLine = Color3.fromRGB(120, 120, 120),
        Text = Color3.fromRGB(255, 255, 255),
