loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=100526204045930",
       Size = {60, 60},
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/linhhehe/Linh/refs/heads/main/TBoyRobloxBF.lua"))()
  end
 })
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://100526204045930",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=100526204045930";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://youtube.com/@linhx2x10?si=eJHmcpQJUKbOc4Itx");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://100526204045930") then
                    return v729;
                end
            end
        end
